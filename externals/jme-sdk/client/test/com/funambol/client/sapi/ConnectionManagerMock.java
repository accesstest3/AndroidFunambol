...
public class ConnectionManagerMock extends ConnectionManager {

    private HttpConnectionAdapterMock testHttpConnectionAdapter = new HttpConnectionAdapterMock();
    ...
    public HttpConnectionAdapterMock getHttpConnectionAdapter() {
        return testHttpConnectionAdapter;
    }
}
