...
/**
 *
 * @version $Id: Parameter.java,v 1.2 2007-11-28 11:14:05 nichele Exp $
 */
public class Parameter implements VisitorInterface, Comparable {
     ...
     * @param v The value of the parameter.
     */
    public Parameter ( String n, boolean x, String v ) {
        name = n;
        custom = x;
        value = v;
    }
    ...
    public Object accept ( VisitorObject v, Object argu ) throws VisitorException {
        return v.visitParameter ( this, argu );
    }
    ...
    public int compareTo ( Object o ) {
        if ( o instanceof Parameter ) {
            Parameter otherParameter = (Parameter) o;
            return this.name.compareTo ( otherParameter.name );
        } else {
