...
/**
 *
 * @version $Id: VTimezone.java,v 1.2 2007-11-28 11:14:05 nichele Exp $
 */
public class VTimezone extends VComponent implements VisitorInterface {
    public static final String COMPONENT_NAME = "VTIMEZONE";
    ...
    public void addStandardc ( TzStandardComponent c ) {
        addComponent ( c );
    }

    public void addDaylightc ( TzDaylightComponent c ) {
        addComponent ( c );
    }
