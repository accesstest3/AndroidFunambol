 ...
 *
 * @version $Id: ConverterException.java,v 1.2 2007-11-28 11:14:04 nichele Exp $
 */
public class ConverterException extends Exception {
     ...
     *               exception
     */
     public ConverterException(final String strMsg) {
         super(strMsg);
     }

     public ConverterException(final String strMsg, final Throwable cause) {
         super(strMsg, cause);
     }
