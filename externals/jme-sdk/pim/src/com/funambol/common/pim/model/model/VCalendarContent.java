...
/**
 * This class does nothing. It's just a common superclass for VEvent and VTodo
 * to be used as a comfortable argument or return type in converters.
 *
 * @version $Id: VCalendarContent.java,v 1.2 2007-11-28 11:14:05 nichele Exp $
 */
public abstract class VCalendarContent 
        extends VComponent implements VisitorInterface{
     ...
     */
    public abstract Object accept( VisitorObject v, Object argu) 
            throws VisitorException ;

    public String toString() {
        StringBuffer buffer = new StringBuffer();
        buffer.append("BEGIN:").append(getVComponentName()).append("\r\n");
        toStringBuffer (buffer);
        buffer.append("END:").append(getVComponentName()).append("\r\n");
