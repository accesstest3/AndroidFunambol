...
import com.funambol.util.ErrorLog;

public class ErrorInterceptAppender implements Appender {
    ...
    public LogContent getLogContent() throws IOException {
        throw new IOException("Cannot get log content for error intercept appender");
    }
}
