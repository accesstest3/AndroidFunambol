...
/**
 * Defines a specific CacheTracker for Android
 */
public abstract class AndroidChangesTracker extends CacheTracker {
    ...
    public AndroidChangesTracker(Context context, StringKeyValueStore status) {
        super(status);
        this.context = context;
    }

    /**
     * @return true if there is any change in the current source
     */
    public boolean hasChanges() {
        boolean result = false;
        begin(SyncML.ALERT_CODE_FAST);
