...
public class ContactAppSyncSourceConfig extends AppSyncSourceConfig {
    ...
    public ContactAppSyncSourceConfig(AppSyncSource appSource, Customization customization, Configuration configuration) {
    ...
    public void save() {
        ...
        configuration.saveBooleanKey(CONF_KEY_MAKE_DEFAULT_ADDRESS_BOOK, makeDefaultAddressBook);
    ...
    public void load(SourceConfig sourceConfig) {
        ...
        makeDefaultAddressBook = configuration.loadBooleanKey(CONF_KEY_MAKE_DEFAULT_ADDRESS_BOOK, false);
    }

    public void setMakeDefaultAddressBook(boolean value) {
        makeDefaultAddressBook = value;
        dirty = true;
    }

    public boolean getMakeDefaultAddressBook() {
        return makeDefaultAddressBook;
    }
}
