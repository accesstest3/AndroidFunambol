...
public class MediaAppSyncSourceConfig extends AppSyncSourceConfig {
    ...
    public MediaAppSyncSourceConfig(MediaAppSyncSource appSource, Customization customization, Configuration configuration) {
    ...
    public void migrateConfig(String from, String to, SourceConfig config) {
        ...
        if (from == null) {
            ...
            Log.info(TAG, "Migrating config from null to 1");
