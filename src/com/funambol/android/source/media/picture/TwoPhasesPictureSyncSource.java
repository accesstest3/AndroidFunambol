...
public class TwoPhasesPictureSyncSource extends TwoPhasesMediaSyncSource {

    private static final String TAG = "TwoPhasesPictureSyncSource";
     ...
     * @param configuration
     */
    public TwoPhasesPictureSyncSource(SourceConfig config, ChangesTracker tracker, Context context,
