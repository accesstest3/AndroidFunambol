...
public class PictureAppSyncSourceConfig extends MediaAppSyncSourceConfig {
    ...
    public PictureAppSyncSourceConfig(MediaAppSyncSource appSource, Customization customization, Configuration configuration) {
    ...
    public void migrateConfig(String from, String to, SourceConfig config) {
        ...
        if (from == null) {
            ...
            String CONF_KEY_INCLUDE_OLDER_PICTURES = "CONF_KEY_INCLUDE_OLDER_PICTURES";
            boolean includeOldPics = configuration.loadBooleanKey(CONF_KEY_INCLUDE_OLDER_PICTURES, false);
            if (includeOldPics) {
