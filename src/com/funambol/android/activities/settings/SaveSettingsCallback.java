...
/**
 * Used to be notified when a tab finishes to save its settings
 */
public class SaveSettingsCallback {
    ...
    public SaveSettingsCallback(boolean close, int count) {
        this.close = close;
        this.count = count;
        this.result = true;
    }
    ...
    public void saveSettingsResult(boolean aResult) {
        result &= aResult;
